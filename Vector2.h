...
inline Vector2Int Vector2::toVec2Int() const { return { static_cast<int>(x), static_cast<int>(y) }; }
inline Vector2Int Vector2::toVec2Int(const Vector2& obj) { return { static_cast<int>(obj.x), static_cast<int>(obj.y) }; }
